...
<footer class="footer3">
    <div class="pied1"><br>
        <img class="pied11" src="Images/logo5.png" alt="logo de The West Agency"/><br><br> 
        * Selon les conditions tarifaires propres à chaque produit et précisées ci-après : <br><br>
